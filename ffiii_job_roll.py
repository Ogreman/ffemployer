...
class ff_job_roll(tkinter.Tk):
	...
	def initialise(self):
		...
		def start_game(self, game, new_game_frame, ff3new_frame):
			def OnFF3WindButtonClick(windButton, fireButton, windLabel, windPicLabel, windStatsLabel, summaryText):
			...
			def OnFF3FireButtonClick(fireButton, waterButton, fireLabel, firePicLabel, fireStatsLabel, summaryText):
			...
			def OnFF3WaterButtonClick(waterButton, earthButton, waterLabel, waterPicLabel, waterStatsLabel, summaryText):
			...
			def OnFF3EarthButtonClick(earthButton, earthLabel, earthPicLabel, earthStatsLabel, summaryText):
			...
			#
			summaryLabel = tkinter.Label(ff3new_frame, textvariable=summaryText,anchor="w",fg="white",bg="black")
			windStatsLabel = tkinter.Label(ff3new_frame, textvariable=windStatsText)
			fireStatsLabel = tkinter.Label(ff3new_frame, textvariable=fireStatsText)
			waterStatsLabel = tkinter.Label(ff3new_frame, textvariable=waterStatsText)
			earthStatsLabel = tkinter.Label(ff3new_frame, textvariable=earthStatsText)
			...
			#
			windLabel = tkinter.Label(ff3new_frame,textvariable=windLabelVariable)
			fireLabel = tkinter.Label(ff3new_frame,textvariable=fireLabelVariable)			
			waterLabel = tkinter.Label(ff3new_frame,textvariable=waterLabelVariable)
			earthLabel = tkinter.Label(ff3new_frame,textvariable=earthLabelVariable)
		...
		ff3rButton = tkinter.Button(new_game_frame,text=u"Final Fantasy III!", state='normal')
